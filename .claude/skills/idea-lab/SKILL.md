...
- **중복 먼저 확인(보완 #12)**: 발굴 웨이브를 보내기 전에 메인이 `lab/batches/all_titles.txt`(id	단계	제목)를 새로 만들고, 발굴자는 후보마다 핵심 명사로 grep해 예전 탈락 사유를 뒤집는 새 증거가 없으면 적지 않는다(재발굴된 중복: i2160=i1396, i2150≈i1274, i2173≈i2015)
