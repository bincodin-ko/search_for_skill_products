...
- **규칙이 의견보다 우선한다.** need ≤ 2 또는 수익성(max(revenue, fame)) ≤ 2면 Drop. **수익성은 두 길**: 유료 고객으로 월 300만 원(revenue) 또는 무료라도 유명해져 광고·파생 제품·제휴·인수로 돈이 되는 길(fame, 기본 목표 1년 월 사용자 1만 명). 예외 후보를 살릴지는 사용자가 정한다
